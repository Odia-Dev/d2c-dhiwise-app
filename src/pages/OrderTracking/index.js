      ...
      <Column className="bg-gray_50 font-gilroy items-center justify-start mx-[auto] lg:pb-[141px] xl:pb-[177px] 2xl:pb-[199px] 3xl:pb-[238px] w-[100%]">
        <header className="w-[100%]">
          <Row className="bg-white_A700 items-center lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] shadow-bs w-[100%]">
            <Img src="images/img_group_1.svg" className="Group" alt="Group" />
            <Input
              value={inputvalue}
        ...
        <Column className="font-opensans items-center justify-start lg:mt-[35px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] w-[88%]">
          ...
          <Row className="font-gilroy items-start justify-between lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] w-[100%]">
            <Column className="bg-white_A700 justify-center lg:p-[20px] xl:p-[25px] 2xl:p-[29px] 3xl:p-[34px] rounded-radius6 shadow-bs1 w-[67%]">
              <Text
                className="font-medium lg:mr-[438px] xl:mr-[547px] 2xl:mr-[616px] 3xl:mr-[739px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] text-black_902 w-[auto]"
                as="h4"
                variant="h4"
              >
                Track your order
              </Text>
              <Row className="items-center mb-[1px] lg:ml-[55px] xl:ml-[69px] 2xl:ml-[78px] 3xl:ml-[93px] lg:mr-[288px] xl:mr-[360px] 2xl:mr-[405px] 3xl:mr-[486px] lg:mt-[20px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] py-[1px] w-[39%]">
                ...
                <Column className="lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] w-[87%]">
                  <Text
                  ...
                  <Text
                    className="font-semibold 3xl:mt-[110px] lg:mt-[65px] xl:mt-[81px] 2xl:mt-[92px] text-bluegray_200 w-[auto]"
                    variant="body1"
                  >
                  ...
                  <Text
                    className="font-semibold 3xl:mt-[102px] lg:mt-[60px] xl:mt-[75px] 2xl:mt-[85px] text-bluegray_200 w-[auto]"
                    variant="body1"
                  >
                    Order Delivered
                  </Text>
            ...
            <Column className="items-center justify-start w-[30%]">
              <Column className="bg-white_A700 justify-start lg:p-[14px] xl:p-[17px] 2xl:p-[20px] 3xl:p-[24px] rounded-radius6 shadow-bs1 w-[100%]">
                <Column className="items-center justify-start 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] w-[94%]">
                  ...
                  <Row className="items-start justify-between lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[100%]">
                    <Text
                      className="font-semibold mt-[2px] text-black_902 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      Total Payment
                    ...
                    <Text
                      className="font-semibold mb-[2px] text-black_902 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      $1120.58
                ...
                <Column className="justify-start mb-[1px] 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] lg:mt-[26px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] w-[45%]">
                  <Text
